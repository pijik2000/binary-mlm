...
/*
Plugin Name: MLM
Plugin URI: http://192.168.100.9/tigerwp
Description: Binary Network
Version: 1.0
Author: Ghanshyam Das Agarwal
Author URI: http://192.168.100.9/tigerwp
License: GPL
*/
...
function mlm_core_install_users()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_users 
			(
...
function mlm_core_install_leftleg()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_leftleg
			(
				id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
function mlm_core_install_rightleg()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_rightleg
			(
				id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
				pkey VARCHAR(15) NOT NULL,
				ukey VARCHAR(15) NOT NULL,
...
function mlm_core_install_country()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_country
			(
				id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
				iso CHAR(2) NOT NULL,
...
function mlm_core_install_currency()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_currency 
			(
				id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
...
function mlm_core_install_commission()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_commission
			(
				id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
function mlm_core_install_bonus()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_bonus
			(
				id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
				date_notified datetime NOT NULL,
...
function mlm_core_install_payout_master()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_payout_master
			(
...
function mlm_core_install_payout()
{
	...
	$sql[] = "CREATE TABLE {$table_prefix}mlm_payout
			(
				  id int(10) unsigned NOT NULL AUTO_INCREMENT,
