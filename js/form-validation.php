function checkUserNameAvailability(str)
{
	...
	xmlhttp.open("GET","../wp-content/plugins/mlm/ajax/check_username.php?action=username&q="+str,true);
	xmlhttp.send();
}
...
function checkReferrerAvailability(str)
{
	...
	xmlhttp.open("GET","../wp-content/plugins/mlm/ajax/check_username.php?action=sponsor&q="+str,true);
	xmlhttp.send();
