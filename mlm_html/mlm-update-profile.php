...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<form name="frm" method="post" action="" onSubmit="return updateFormValidation();">
		...
		<tr>
			...
			<td><input type="text" name="postalcode" id="postalcode" value="<?= $user_info->user_postalcode;?>" maxlength="20" size="37" onBlur="return allowspace(this.value,'postalcode');"></td>
		</tr>
