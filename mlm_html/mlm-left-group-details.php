...
function myLeftGroupDetails()
{
	...
	//echo "<pre>";print_r($totalLeftLegUsers);exit;
?>
			...
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					Total Users: <strong><?= $leftLegUsers; ?></strong>&nbsp;Active Users: <strong><?= $leftLegActiveUsers; ?></strong>
					</div>
