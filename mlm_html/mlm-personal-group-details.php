<?php
function myPersonalGroupDetails()
{
	...
	//echo "<pre>";print_r($totalPersonalLegUsers);exit;
?>
			...
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					Total Users: <strong><?= $personalLegUsers; ?></strong>&nbsp;Active Users: <strong><?= $personalLegActiveUsers; ?></strong>
					</div>
