...
?>
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" name="user_address1" id="user_address1" value="<?php echo esc_attr( get_the_author_meta( 'user_address1', $user->ID ) ); ?>" class="regular-text" required = true /><br />
		...
		<tr>
			...
			<td>
				<input type="text" name="user_city" id="user_city" value="<?php echo esc_attr( get_the_author_meta( 'user_city', $user->ID ) ); ?>" class="regular-text" required = true /><br />
				<!-- <span class="description">Please edit here your address.</span> -->
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="user_state" id="user_state" value="<?php echo esc_attr( get_the_author_meta( 'user_state', $user->ID ) ); ?>" class="regular-text" required = true /><br />
				<!-- <span class="description">Please edit here your address.</span> -->
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="user_postalcode" id="user_postalcode" value="<?php echo esc_attr( get_the_author_meta( 'user_postalcode', $user->ID ) ); ?>" class="regular-text" required = true /><br />
				<!-- <span class="description">Please edit here your address.</span> -->
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="user_telephone" id="user_telephone" value="<?php echo esc_attr( get_the_author_meta( 'user_telephone', $user->ID ) ); ?>" class="regular-text" required = true /><br />
				<!-- <span class="description">Please edit here your address.</span> -->
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="user_dob" id="user_dob" value="<?php echo esc_attr( get_the_author_meta( 'user_dob', $user->ID ) ); ?>" class="regular-text" required = true /><br />
				<!-- <span class="description">Please edit here your address.</span> -->
			</td>
		</tr>
